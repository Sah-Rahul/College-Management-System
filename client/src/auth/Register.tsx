...
import { registerApi, RegisterDto } from "../Api/services/auth.service";
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await registerApi(formData as RegisterDto);
  ...
  return (
    <div className="flex min-h-screen font-sans">
      <div className="hidden lg:flex w-1/2 bg-[#0F172A] dark:bg-black items-center justify-center p-12 relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-black">
        <form onSubmit={handleSubmit} className="w-full max-w-105 space-y-8">
          ...
          <p className="text-center text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <Link href="/auth/login" className="font-bold text-[#0ab89c]">
              Sign In
            </Link>
          </p>
        </form>
